...
-- Reconstruction of the live project before hardening: sections 1-8 of the
-- previous full_schema.sql (tables, SECURITY DEFINER RPCs, open policies),
-- without the knowledge graph tables and fts columns. Copied verbatim below.
