...
-- The previous full_schema.sql (v2.0.0) verbatim: a fresh install from before
-- hardening, including knowledge_entities / knowledge_relations without
-- owner_id / is_public and with open policies.
